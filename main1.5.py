...
def start_camera():
    ...
    while True:
        ...
        # Premi 'q' per uscire dalla fotocamera
...
# Pulsante per terminare l'allenamento
end_button = tk.Button(root, text="Fine Allenamento", command=root.quit)
